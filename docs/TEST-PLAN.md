...
| — | Copy claimed a 4% house edge | The effective spread is far wider by construction | Copy now states the fee, the conservatism, and the measured effective edge (about 3% to about 42% across four disjoint windows of held-out tape, driven by regime rather than round length) |
